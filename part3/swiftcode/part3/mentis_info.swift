...
class mentis_info: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.hashtag2.topAnchor.constraint(equalTo: cell.info.bottomAnchor, constant: 8.adjusted).isActive = true
    ...
    @objc func handleTap(_ gesture: UITapGestureRecognizer) {
            let storyboard: UIStoryboard = UIStoryboard(name: "part3", bundle: nil)
