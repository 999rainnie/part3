...
class modify_info: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        return_btn.topAnchor.constraint(equalTo: margins.topAnchor, constant: 42.h_adjusted).isActive = true
        ...
        title_text.topAnchor.constraint(equalTo: margins.topAnchor, constant: 43.h_adjusted).isActive = true
        ...
        profile_img.topAnchor.constraint(equalTo: return_btn.bottomAnchor, constant: 48.h_adjusted).isActive = true
        ...
        camera_btn.topAnchor.constraint(equalTo: title_text.bottomAnchor, constant: 159.h_adjusted).isActive = true
        
        hash1.leadingAnchor.constraint(equalTo: profile_img.trailingAnchor, constant: 30.adjusted).isActive = true
        hash1.topAnchor.constraint(equalTo: title_text.bottomAnchor, constant: 93.h_adjusted).isActive = true
        
        hash2.leadingAnchor.constraint(equalTo: hash1.trailingAnchor, constant: 10.adjusted).isActive = true
        hash2.topAnchor.constraint(equalTo: title_text.bottomAnchor, constant: 93.h_adjusted).isActive = true
        
        hash3.leadingAnchor.constraint(equalTo: profile_img.trailingAnchor, constant: 30.adjusted).isActive = true
        hash3.topAnchor.constraint(equalTo: hash1.bottomAnchor, constant: 25.h_adjusted).isActive = true
        
        hash4.leadingAnchor.constraint(equalTo: hash3.trailingAnchor, constant: 10.adjusted).isActive = true
        hash4.topAnchor.constraint(equalTo: hash2.bottomAnchor, constant: 25.h_adjusted).isActive = true
        ...
        for (n, t) in text.enumerated(){
            ...
            t.topAnchor.constraint(equalTo: label[n].bottomAnchor, constant: 11.h_adjusted).isActive = true
        }
        for (n, l) in label.enumerated(){
            ...
            if (n != 0){
                l.topAnchor.constraint(equalTo: text[n-1].bottomAnchor, constant: 13.h_adjusted).isActive = true
            }
        }
        label1.topAnchor.constraint(equalTo: profile_img.bottomAnchor, constant: 45.h_adjusted).isActive = true
        ...
        text_multiline.topAnchor.constraint(equalTo: label8.bottomAnchor, constant: 11.h_adjusted).isActive = true
        ...
        save_btn.topAnchor.constraint(equalTo: text_multiline.bottomAnchor, constant: 71.h_adjusted).isActive = true
        ...
        modify_btn.topAnchor.constraint(equalTo: text_multiline.bottomAnchor, constant: 71.h_adjusted).isActive = true
    }
