...
class men_info: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        return_btn.topAnchor.constraint(equalTo: margins.topAnchor, constant:33.h_adjusted).isActive = true
        ...
        return_txt.topAnchor.constraint(equalTo: margins.topAnchor, constant: 33.h_adjusted).isActive = true
        ...
        label1.topAnchor.constraint(equalTo: return_txt.bottomAnchor, constant: 65.h_adjusted).isActive = true
        ...
        text1.topAnchor.constraint(equalTo: label1.bottomAnchor, constant: 8.h_adjusted).isActive = true
        ...
        label2.topAnchor.constraint(equalTo: text1.bottomAnchor, constant: 21.h_adjusted).isActive = true
        ...
        text2.topAnchor.constraint(equalTo: label2.bottomAnchor, constant: 8.h_adjusted).isActive = true
        ...
        label3.topAnchor.constraint(equalTo: text2.bottomAnchor, constant: 21.h_adjusted).isActive = true
        ...
        text3.topAnchor.constraint(equalTo: label3.bottomAnchor, constant: 8.h_adjusted).isActive = true
        ...
        label4.topAnchor.constraint(equalTo: text3.bottomAnchor, constant: 21.h_adjusted).isActive = true
        ...
        text4.topAnchor.constraint(equalTo: label4.bottomAnchor, constant: 8.h_adjusted).isActive = true
        ...
        button.topAnchor.constraint(equalTo: text4.bottomAnchor, constant: 166.h_adjusted).isActive = true
        ...
        button_menti.topAnchor.constraint(equalTo: text4.bottomAnchor, constant: 100.h_adjusted).isActive = true
