...
class Device {
  ...
  static var w_ratio: CGFloat {
    return UIScreen.main.bounds.width / width
  }
    
    static let height: CGFloat = 926
    static var h_ratio: CGFloat {
...
extension CGFloat {
  var adjusted: CGFloat {
    return self * Device.w_ratio
  }
    
  var h_adjusted: CGFloat {
    return self * Device.h_ratio
  }
}
extension Double {
  var adjusted: CGFloat {
    return CGFloat(self) * Device.w_ratio
  }
    
  var h_adjusted: CGFloat {
    return CGFloat(self) * Device.h_ratio
  }
}
...
class ViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        label1.topAnchor.constraint(equalTo: margins.topAnchor, constant: 133.h_adjusted).isActive = true
        ...
        icon1.topAnchor.constraint(equalTo: margins.topAnchor, constant: 133.h_adjusted).isActive = true
        ...
        etcpage_btn1.topAnchor.constraint(equalTo: margins.topAnchor, constant: 119.h_adjusted).isActive = true
        ...
        label2.topAnchor.constraint(equalTo: etcpage_btn1.bottomAnchor, constant: 21.h_adjusted).isActive = true
        ...
        icon2.topAnchor.constraint(equalTo: etcpage_btn1.bottomAnchor, constant: 21.h_adjusted).isActive = true
        ...
        etcpage_btn2.topAnchor.constraint(equalTo: etcpage_btn1.bottomAnchor, constant: 6.h_adjusted).isActive = true
        ...
        label3.topAnchor.constraint(equalTo: etcpage_btn2.bottomAnchor, constant: 17.h_adjusted).isActive = true
        ...
        icon3.topAnchor.constraint(equalTo: etcpage_btn2.bottomAnchor, constant: 17.h_adjusted).isActive = true
        ...
        etcpage_btn3.topAnchor.constraint(equalTo: etcpage_btn2.bottomAnchor, constant: 4.h_adjusted).isActive = true
        ...
        label4.topAnchor.constraint(equalTo: etcpage_btn3.bottomAnchor, constant: 18.h_adjusted).isActive = true
        ...
        icon4.topAnchor.constraint(equalTo: etcpage_btn3.bottomAnchor, constant: 18.h_adjusted).isActive = true
        ...
        etcpage_btn4.topAnchor.constraint(equalTo: etcpage_btn3.bottomAnchor, constant: 3.h_adjusted).isActive = true
        ...
        label5.topAnchor.constraint(equalTo: etcpage_btn4.bottomAnchor, constant: 16.h_adjusted).isActive = true
        ...
        icon5.topAnchor.constraint(equalTo: etcpage_btn4.bottomAnchor, constant: 16.h_adjusted).isActive = true
        ...
        etcpage_btn5.topAnchor.constraint(equalTo: etcpage_btn4.bottomAnchor, constant: 3.h_adjusted).isActive = true
        // Do any additional setup after loading the view.
    }
    
    @IBAction func moveNext(_ sender: Any) {
        let storyBoard = UIStoryboard.init(name:"part3", bundle:nil)
