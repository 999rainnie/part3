...
class reason_check: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        caution_title.topAnchor.constraint(equalTo: margins.topAnchor, constant: 0.h_adjusted).isActive = true
        ...
        text.topAnchor.constraint(equalTo: caution_title.bottomAnchor, constant: 63.h_adjusted).isActive = true
        ...
        reason.topAnchor.constraint(equalTo: caution_title.bottomAnchor, constant: 135.h_adjusted).isActive = true
        ...
        for (n, c) in check_list.enumerated(){
            ...
            if ((n != 0)){
                c.topAnchor.constraint(equalTo: check_list[n-1].bottomAnchor, constant: 50.h_adjusted).isActive = true
            }
        }
        ...
        for (n, c) in non_check_list.enumerated(){
            ...
            c.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 40.adjusted).isActive = true
            if ((n != 0)){
                c.topAnchor.constraint(equalTo: non_check_list[n-1].bottomAnchor, constant: 50.h_adjusted).isActive = true
            }
        }
        
        check_btn1.topAnchor.constraint(equalTo: reason.bottomAnchor, constant: 41.h_adjusted).isActive = true
        noncheck_btn1.topAnchor.constraint(equalTo: reason.bottomAnchor, constant: 41.h_adjusted).isActive = true
        ...
        for (n, t) in text_list.enumerated(){
            ...
            if (n != 0){
            t.topAnchor.constraint(equalTo: text_list[n-1].bottomAnchor, constant: 30.h_adjusted).isActive = true
            }
        }
        text1.topAnchor.constraint(equalTo: reason.bottomAnchor, constant: 31.h_adjusted).isActive = true
        ...
        discon_btn.topAnchor.constraint(equalTo: text4.bottomAnchor, constant: 74.h_adjusted).isActive = true
    }
